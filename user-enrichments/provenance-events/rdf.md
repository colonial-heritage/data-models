...
Example: an object was sold by an actor to another actor, but it's uncertain whether this actually happened ('it possibly happened')
...
temp-nanopub-id:pubinfo {
    ...
    temp-nanopub-id:
        ...
        npx:introduces <https://nanopublication.example/1> . # Reference to the information contributed by a user
...
## Type: transfer of custody

Example: an object was transferred from an actor to another actor
...
# The contribution of a user
temp-nanopub-id:assertion {
    <https://nanopublication.example/2> # IRI for illustration only; will be a blank node in practice
        a crm:E13_Attribute_Assignment ;
...
temp-nanopub-id:pubinfo {
    ...
    temp-nanopub-id:
        ...
        dcterms:license <https://creativecommons.org/licenses/by/4.0/> ;
        npx:wasCreatedWith <https://app.colonialcollections.nl/> ;
        npx:introduces <https://nanopublication.example/2> . # Reference to the information contributed by a user
